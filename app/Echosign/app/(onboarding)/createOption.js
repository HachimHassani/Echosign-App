    ...
    <View className="flex-1 items-center bg-cyan-400">
      ...
      <View className="flex w-full h-[87%] rounded-t-[30] justify-center items-center bg-white ">
        <View className="flex h-[30%] justify-center">
            <Text className="text-black text-2xl opacity-60 font-medium leading-loose mb-4 px-7">Now create an account !</Text>
            <Text className="px-7  text-black text-md opacity-60 mb-3 ">You have to create an account to join the deaf-mute community and talk to peaople all around the globe !</Text>
            <Text className="px-7  text-black text-md opacity-60 underline">already have an accout ? log in</Text>
