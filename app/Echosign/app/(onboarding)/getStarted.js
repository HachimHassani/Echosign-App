...
export default function getStarted() {
  ...
  return (
    <View className="flex-1 items-center bg-[#1AA6B7] ">
      <StatusBar hidden />
      ...
      <View className="flex w-full h-[40%] rounded-t-[30] justify-center items-center bg-white p-2 ">
        <View className="flex h-[70%] justify-center mt-0">
          <Text className="text-black text-3xl font-medium leading-9 mb-4 ml-5">
            Let’s start
            <Text className="text-4xl text-[#1AA6B7] font-bold ">
              {" "}
              Speaking{"\n"}
            </Text>
            with our
          ...
          <Text className="  text-black text-md opacity-60 mx-5 ">
            complete app to start learning sign language and get along with the
            deaf-mute community
          </Text>
        </View>
